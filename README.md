...
2 : Add the required module export 
3 : Add the employee array
4 : Add questions for all the employes and then for each role
5 : Add function to initialize the app
6 : Add a function for the cration of new employes
7 : Function to generate an index.html when the user its done
